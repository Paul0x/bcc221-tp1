...
${OBJECTDIR}/AssistenteAdministrativo.o: AssistenteAdministrativo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AssistenteAdministrativo.o AssistenteAdministrativo.cpp
...
${OBJECTDIR}/Funcionario.o: Funcionario.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Funcionario.o Funcionario.cpp

${OBJECTDIR}/RegistroAgenda.o: RegistroAgenda.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RegistroAgenda.o RegistroAgenda.cpp

${OBJECTDIR}/RegistroPagamentoConsulta.o: RegistroPagamentoConsulta.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RegistroPagamentoConsulta.o RegistroPagamentoConsulta.cpp

${OBJECTDIR}/RegistroPagamentoConta.o: RegistroPagamentoConta.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RegistroPagamentoConta.o RegistroPagamentoConta.cpp

${OBJECTDIR}/RegistroPonto.o: RegistroPonto.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RegistroPonto.o RegistroPonto.cpp

${OBJECTDIR}/SistemaClinica.o: SistemaClinica.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SistemaClinica.o SistemaClinica.cpp
